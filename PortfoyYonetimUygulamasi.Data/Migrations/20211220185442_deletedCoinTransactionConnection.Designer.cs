...
namespace PortfoyYonetimUygulamasi.Data.Migrations
{
    ...
    [Migration("20211220185442_deletedCoinTransactionConnection")]
    partial class deletedCoinTransactionConnection
    {
            ...
            modelBuilder.Entity("PortfoyYonetimUygulamasi.Entity.Concrete.Transaction", b =>
                {
                    ...
                    b.HasOne("PortfoyYonetimUygulamasi.Entity.Concrete.TransactionType", "TransactionType")
                        .WithOne("Transaction")
